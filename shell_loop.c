 ...
 *
 * Return: 0 (Success), 1 when an error occurs.
 */
 ...
 *
 * Return: -1 if builtin command is no found,
 * 1,if the builtin command is found but not successful, 0
 * if builtin is executed successfully
