...
/**
 * struct passinfo - this struct contains the pseudo-arguments to pass
 * into a function,
 ...
 * @linecount_flag: if on count this line of the input
...
typedef struct passinfo
{
	...
	int env_changed;
	int status;
	char **cmd_buf; /* the pointer to cmd ; chain buffer, for memory management */
...
/**
 * struct builtin - this struct contains a builtin string and related function.
